    ...
    <div class="mb-5">
      <Slider {...settings}>
        {confidences.Positivo.confidence !== 0 ?
          <div>
            <p class='flex w-screen'>Tweet de caracter mas positivo:</p>
            <div class="tweet w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
              <div className="tweet-header">
                <img className='image-tweet rounded-full width-20 h-20' src={profileURL} alt="timeline" />
              </div>
        ...
        {confidences.Toxico.confidence !== 0 ?
          <div>
            <p class='flex w-screen'>Tweet de caracter mas Toxico:</p>
            <div class="tweet w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
              <div className="tweet-header">
                <img className='image-tweet rounded-full width-20 h-20' src={profileURL} alt="timeline" />
              </div>
        ...
        {confidences.Developer.confidence !== 0 ?
          <div>
            <p class='flex w-screen'>Tweet de caracter mas Developer:</p>
            <div class="tweet w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
              <div className="tweet-header">
                <img className='image-tweet rounded-full width-20 h-20' src={profileURL} alt="timeline" />
              </div>
        ...
        {confidences.Gamer.confidence !== 0 ?
          <div>
            <p class='flex w-screen'>Tweet de caracter mas Gamer:</p>
            <div class="tweet w-full p-4 text-center bg-white border border-gray-200 rounded-lg shadow sm:p-8 dark:bg-gray-800 dark:border-gray-700">
              <div className="tweet-header">
                <img className='image-tweet rounded-full width-20 h-20' src={profileURL} alt="timeline" />
              </div>
